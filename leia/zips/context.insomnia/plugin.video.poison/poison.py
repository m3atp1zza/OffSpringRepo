...
if action == 'lista':
    from resources.lib.indexers import playlists
    playlists.indexer().root_lista()

if action == 'listb':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listb()

if action == 'listc':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listc()

if action == 'listd':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listd()

if action == 'liste':
    from resources.lib.indexers import playlists
    playlists.indexer().root_liste()

if action == 'listf':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listf()

if action == 'plistg':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listg()

if action == 'listg':
    from resources.lib.indexers import playlists
    playlists.indexer().root_klistg()

if action == 'listh':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listh()

if action == 'listi':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listi()

if action == 'listj':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listj()

if action == 'listk':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listk()

if action == 'listl':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listl()

if action == 'listm':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listm()

if action == 'listn':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listn()

if action == 'listo':
    from resources.lib.indexers import playlists
    playlists.indexer().root_listo()
...
elif action == 'poisonscrapersettings':
    from resources.lib.modules import control
    control.openSettings('0.0', 'script.module.poisonscrapers')

elif action == 'installPoisonScrapers':
    from resources.lib.modules import control
    control.installAddon('script.module.poisonscrapers')
    control.sleep(200)
    control.refresh()
