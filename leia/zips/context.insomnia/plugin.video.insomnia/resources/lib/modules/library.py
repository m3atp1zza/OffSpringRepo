...
class libmovies:
	...
	def auto_movie_setup(self):
		try:
			...
			# control.add_source('INSOMNIA Movies', self.library_folder, source_content, icon)
			library_sources.add_source('INSOMNIA Movies', self.library_folder, source_content, 'DefaultMovies.png')
		except:
			log_utils.error()
