...
class libmovies:
	...
	def auto_movie_setup(self):
		try:
			...
			# control.add_source('PoisonIvy Movies', self.library_folder, source_content, icon)
			library_sources.add_source('PoisonIvy Movies', self.library_folder, source_content, 'DefaultMovies.png')
		except:
			log_utils.error()
...
class libtvshows:
	...
	def auto_tv_setup(self):
		try:
			...
			source_name = 'PoisonIvy TV Shows'
			# TVDb scraper
