...
def router(params):
    ...
    if action is None:
        ...
        isUpdate = control.homeWindow.getProperty('poisonivy.updated')
        if isUpdate == 'true':
            control.execute('RunPlugin(plugin://plugin.video.poisonivy/?action=tools_cleanSettings)')
            control.homeWindow.clearProperty('poisonivy.updated')
    ...
    ####################################################
        ...
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root()
    elif action == 'lista':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_lista()
    elif action == 'listb':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listb()
    elif action == 'listc':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listc()
    elif action == 'listd':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listd()
    elif action == 'liste':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_liste()
    elif action == 'listf':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listf()
    elif action == 'listg':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listg()
    elif action == 'listh':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listh()
    elif action == 'listi':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listi()
    elif action == 'listj':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listj()
    elif action == 'listk':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listk()
    elif action == 'listl':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listl()
    elif action == 'listm':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listm()
    elif action == 'listn':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listn()
    elif action == 'listo':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listo()
    elif action == 'listp':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listp()
    elif action == 'listq':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listq()
    elif action == 'listr':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listr()
    elif action == 'lists':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_lists()
    elif action == 'listt':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listt()
    elif action == 'listu':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listu()
    elif action == 'listv':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listv()
    elif action == 'listw':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listw()
    elif action == 'listx':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listx()
    elif action == 'listy':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listy()
    elif action == 'listz':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().root_listz()
    ####################################################
    elif action == 'directory':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().get(url)
    elif action == 'qdirectory':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().getq(url)
    elif action == 'xdirectory':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().getx(url)
    elif action == 'developer':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().developer()
    elif action == 'tvtuner':
        from resources.lib.menus import poisonivylist
        poisonivylist.indexer().tvtuner(url)
    elif action == 'poisonivylist_play':
        from resources.lib.menus import poisonivylist
        if not content == None:
            poisonivylist.player().play(url, content)
        else:
            from resources.lib.modules import sources
            sources.Sources().play(title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, meta, select)
    elif action == 'browser':
        from resources.lib.menus import poisonivylist
        poisonivylist.resolver().browser(url)

    ####################################################
    #--- Poison IMDB Lists
    ####################################################
    elif action == 'poisonIMDBNavigator':
        from resources.lib.menus import navigator
        navigator.Navigator().poisonimdb()

    elif action == 'poison':
        from resources.lib.menus import navigator
        navigator.Navigator().poison()
    ...
    ####################################################
        ...
        if action == 'tools_ShowNews':
            ...
            if params.get('opensettings') == 'true':
                control.openSettings(params.get('query2'), 'plugin.video.poisonivy')
        elif action == 'tools_syncMyAccount':
            from resources.lib.modules import my_accounts
            my_accounts.syncMyAccounts()
            if params.get('opensettings') == 'true':
                control.openSettings(query, 'plugin.video.poisonivy')
        ...
        elif action == 'tools_contextPoisonIvySettings':
            control.openSettings('0.0', 'context.poisonivy')
    ...
    ####################################################
        ...
        if action == 'play_Item':
            ...
            for i in items:
                ...
                url = 'plugin://plugin.video.poisonivy/?action=play_Item&title=%s&year=%s&imdb=%s&tmdb=%s&tvdb=%s&season=%s&episode=%s&tvshowtitle=%s&premiered=%s&meta=%s&select="1"' % (
            ...
            if rtype == 'movie':
                ...
                r = 'plugin://plugin.video.poisonivy/?action=play_Item'
            elif rtype == 'episode':
                from resources.lib.menus import episodes
                meta = params.get('meta')
                ...
                r = 'plugin://plugin.video.poisonivy/?action=play_Random&rtype=episode'
            elif rtype == 'show':
                from resources.lib.menus import tvshows
                rlist = tvshows.TVshows().get(url, create_directory=False)
                r = 'plugin://plugin.video.poisonivy/?action=play_Random&rtype=season'
    ...
    ####################################################
        ...
        elif action == 'cache_clearKodiBookmark': # context.poisonivy action call only
