...
##################
		...
		try:
			...
			if action == 'play_Item' and self.uncached_chosen != True:
				return self.playItem(title, items, chosen_source.getProperty('poisonivy.source_dict'), self.meta)
			else:
				control.cancelPlayback()
		except:
			log_utils.error('Error sourceSelect(): ')
	...
	def getConstants(self):
		# self.itemProperty = 'plugin.video.poisonivy.container.items'
		self.metaProperty = 'plugin.video.poisonivy.container.meta'
		self.seasonProperty = 'plugin.video.poisonivy.container.season'
		self.episodeProperty = 'plugin.video.poisonivy.container.episode'
		self.titleProperty = 'plugin.video.poisonivy.container.title'
		self.imdbProperty = 'plugin.video.poisonivy.container.imdb'
		self.tmdbProperty = 'plugin.video.poisonivy.container.tmdb'
		self.tvdbProperty = 'plugin.video.poisonivy.container.tvdb'
		self.labelProperty = 'plugin.video.poisonivy.container.label'
