...
# poison IMDB Movies
        self.poisoncreep_link = 'https://www.imdb.com/list/ls500371586/?sort=release_date,desc&st_dt=&mode=detail&count=%s&start=1' % self.count
        self.poisonpicks_link = 'https://www.imdb.com/list/ls500375959/?sort=release_date,desc&st_dt=&mode=detail&count=%s&start=1' % self.count
        self.poisonspace_link = 'https://www.imdb.com/list/ls500348581/?sort=release_date,desc&st_dt=&mode=detail&count=%s&start=1' % self.count
        self.poisonwildw_link = 'https://www.imdb.com/list/ls500842793/?sort=release_date,desc&st_dt=&mode=detail&count=%s&start=1' % self.count
        self.poisondocs_link = 'https://www.imdb.com/list/ls500889584/?sort=release_date,desc&st_dt=&mode=detail&count=%s&start=1' % self.count
...
####-Context Menu and Overlays-####
                ...
                cm.append(('[COLOR yellowgreen]PoisonIvy Settings[/COLOR]', 'RunPlugin(%s?action=tools_openSettings)' % sysaddon))
####################################
                ...
                if is_widget: item.setProperty('isPoisonIvy_widget', 'true')
