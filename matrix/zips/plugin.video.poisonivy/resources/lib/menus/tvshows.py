...
# poison IMDB Tv Lists
        self.poisonbreak_link = 'https://www.imdb.com/list/ls500365647/?view=detail&sort=alpha,asc&title_type=tvSeries,tvMiniSeries&count=%s&start=1' % self.count
        self.poisonwow_link = 'https://www.imdb.com/list/ls500293183/?view=detail&sort=alpha,asc&title_type=tvSeries,tvMiniSeries&count=%s&start=1' % self.count
        self.poisongos_link = 'https://www.imdb.com/list/ls505000411/?view=detail&sort=alpha,asc&title_type=tvSeries,tvMiniSeries&count=%s&start=1' % self.count
...
####-Context Menu and Overlays-####
                ...
                cm.append(('[COLOR lawngreen]Poison Ivy Settings[/COLOR]', 'RunPlugin(%s?action=tools_openSettings)' % sysaddon))
####################################
