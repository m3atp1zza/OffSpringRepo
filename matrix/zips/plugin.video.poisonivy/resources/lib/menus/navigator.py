...
class Navigator:
    ...
    def root(self):
        self.addDirectoryItem('[COLOR lawngreen]PoisonIvy[/COLOR] IMDB Lists', 'PoisonIvyIMDBNavigator', 'list.png', 'DefaultMovies.png')
        self.addDirectoryItem('[COLOR lawngreen]PoisonIvy[/COLOR] Movie Lists' , 'listNavigator', 'list.png', 'DefaultTVShows.png')
        ...
        if control.getMenuEnabled('navi.anime'): self.addDirectoryItem('Anime', 'anime_Navigator', 'icon.png', 'DefaultFolder.png')
    ...
    def PoisonIvyimdb(self, lite=False):
        self.addDirectoryItem('[COLOR lawngreen]PoisonIvy[/COLOR]', 'PoisonIvy', 'list.png', 'DefaultMovies.png')
        self.endDirectory()

    def listnav(self):
        self.addDirectoryItem ('[COLOR lawngreen]PoisonIvy[/COLOR] [COLOR white]New Movie 1Clicks[/COLOR] [COLOR dodgerblue][Real Debrid][/COLOR]', 'list', 'list.png', 'DefaultTVShows.png')
    ...
    def PoisonIvy(self, lite=False):
        self.addDirectoryItem('New Movies (Some movies may NOT play until streaming is available)', 'movies&url=PoisonIvypicks', 'list.png', 'DefaultMovies.png')
        self.addDirectoryItem('Creep Shows', 'movies&url=PoisonIvycreep', 'list.png', 'DefaultMovies.png')
        self.addDirectoryItem('Space Odyssey', 'movies&url=PoisonIvyspace', 'list.png', 'DefaultMovies.png')
        self.addDirectoryItem('Wild West', 'movies&url=PoisonIvywildw', 'list.png', 'DefaultMovies.png')
        self.addDirectoryItem('Docs', 'movies&url=PoisonIvydocs', 'list.png', 'DefaultMovies.png')
        self.addDirectoryItem('Breaking Law TV', 'tvshows&url=PoisonIvybreak', 'list.png', 'DefaultTVShows.png')
        self.addDirectoryItem('World of Wheels TV', 'tvshows&url=PoisonIvywow', 'list.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Game of Shows TV', 'tvshows&url=PoisonIvygos', 'list.png', 'DefaultTVShows.png')
        self.endDirectory()
    ...
    def tools(self):
        ...
        self.addDirectoryItem(32506, 'tools_contextPoisonIvySettings', 'icon.png', 'DefaultAddonProgram.png', isFolder=False)
        #-- Providers - 4
    ...
    def premium_services(self):
        self.addDirectoryItem(40059, 'ad_ServiceNavigator', 'premium.png', 'DefaultAddonService.png')
        self.addDirectoryItem(40057, 'pm_ServiceNavigator', 'premium.png', 'DefaultAddonService.png')
        self.addDirectoryItem(40058, 'rd_ServiceNavigator', 'premium.png', 'DefaultAddonService.png')
        self.endDirectory()

    def alldebrid_service(self):
        if control.setting('alldebrid.token'):
            self.addDirectoryItem('All-Debrid: Cloud Storage', 'ad_CloudStorage', 'premium.png', 'DefaultAddonService.png')
            self.addDirectoryItem('All-Debrid: Transfers', 'ad_Transfers', 'premium.png', 'DefaultAddonService.png')
            self.addDirectoryItem('All-Debrid: Account Info', 'ad_AccountInfo', 'premium.png', 'DefaultAddonService.png', isFolder=False)
        else:
            self.addDirectoryItem('[I]Please visit My Accounts for setup[/I]', 'tools_openMyAccount&amp;query=1.4', 'premium.png', 'DefaultAddonService.png', isFolder=False)
        self.endDirectory()

    def premiumize_service(self):
        if control.setting('premiumize.token'):
            self.addDirectoryItem('Premiumize: My Files', 'pm_MyFiles', 'premium.png', 'DefaultAddonService.png')
            self.addDirectoryItem('Premiumize: Transfers', 'pm_Transfers', 'premium.png', 'DefaultAddonService.png')
            self.addDirectoryItem('Premiumize: Account Info', 'pm_AccountInfo', 'premium.png', 'DefaultAddonService.png', isFolder=False)
        else:
            self.addDirectoryItem('[I]Please visit My Accounts for setup[/I]', 'tools_openMyAccount&amp;query=1.11', 'premium.png', 'DefaultAddonService.png', isFolder=False)
        self.endDirectory()

    def realdebrid_service(self):
        if control.setting('realdebrid.token'):
            self.addDirectoryItem('Real-Debrid: Torrent Transfers', 'rd_UserTorrentsToListItem', 'premium.png', 'DefaultAddonService.png')
            self.addDirectoryItem('Real-Debrid: My Downloads', 'rd_MyDownloads&query=1', 'premium.png', 'DefaultAddonService.png')
            self.addDirectoryItem('Real-Debrid: Account Info', 'rd_AccountInfo', 'premium.png', 'DefaultAddonService.png',isFolder=False )
        else:
            self.addDirectoryItem('[I]Please visit My Accounts for setup[/I]', 'tools_openMyAccount&amp;query=1.18', 'premium.png', 'DefaultAddonService.png', isFolder=False)
        self.endDirectory()
    ...
    def addDirectoryItem(self, name, query, thumb, icon, context=None, queue=False, isAction=True, isFolder=True, isPlayable=False, isSearch=False, table=''):
        ...
        cm.append(('[COLOR lawngreen]PoisonIvy Settings[/COLOR]', 'RunPlugin(%s?action=tools_openSettings)' % sysaddon))
